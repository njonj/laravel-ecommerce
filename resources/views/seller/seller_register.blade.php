...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div class="wrapper without_header_sidebar">
          ...
          <input  type="text" class="form-control" name="name" value=" " required autocomplete="name"  placeholder="Full Name">

                                <span class="icon_soon_bottom_right"><i class="fas fa-user"></i></span>
                            </div>
                            <div class="form-group icon_parent">
                                <label for="uname">Username</label>
          <input  type="text" class="form-control" name="username" value=" " required autocomplete="username"  aria-placeholder="Username">
         ...
         <input  type="phone" class="form-control" name="phone_no" value=" " required autocomplete="phone" aria-placeholder="Phone Number">
